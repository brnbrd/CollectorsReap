...
public class VDLootItemConditions {

	private static final DeferredRegister<LootItemConditionType> LICT = DeferredRegister.create(Registry.LOOT_CONDITION_TYPE.key(), VeggieDelight.MODID);
