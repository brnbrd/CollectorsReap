...
public class ClamModel extends HierarchicalModel<Clam> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Top = Main.addOrReplaceChild("Top", CubeListBuilder.create().texOffs(0, 13).addBox(-5.0F, -7.0F, -6.0F, 10.0F, 3.0F, 10.0F, new CubeDeformation(0.0F))
			.texOffs(24, 28).addBox(-4.0F, -9.0F, -5.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 0.0F, 0.0F));
	...
	public void setupAnim(@NotNull Clam entity, float limbSwing, float limbSwingAmount, float age, float netHeadYaw, float headPitch) {
		...
		this.animate(entity.closedAnimationState, ClamAnimation.CLAM_CLOSED, age);
		//this.animate(entity.openAnimationState, ClamAnimation.CLAM_OPEN, age);
	}
