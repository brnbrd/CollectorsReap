...
public class SmallPomegranateBushBlock extends BushBlock implements BonemealableBlock {
	...
	public SmallPomegranateBushBlock(Properties properties) {
		super(properties);
	}
	...
	public @NotNull ItemStack getCloneItemStack(@NotNull BlockGetter world, @NotNull BlockPos pos, @NotNull BlockState state) {
		return new ItemStack(CRItems.POMEGRANATE_SEEDS.get());
	}
	...
	public void performBonemeal(ServerLevel world, @NotNull RandomSource rand, @NotNull BlockPos pos, @NotNull BlockState state) {
		world.setBlockAndUpdate(pos, CRBlocks.MEDIUM_LEMON_BUSH.get().defaultBlockState());
	}
